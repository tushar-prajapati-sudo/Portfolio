...
export function Hero() {
  return (
    <section
      id="top"
      className="pointer-events-none relative flex min-h-screen flex-col items-center justify-center gap-5 px-4 pt-24 sm:gap-6 sm:px-6"
    >
      {/* Warm amber + cool blue glows for a richer hero. */}
      <Spotlight
      ...
      <div className="relative h-[26vh] w-full max-w-5xl sm:h-[32vh]">
